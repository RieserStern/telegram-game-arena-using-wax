...
class GamesManager {
  ...
  getPlayerGame(playerId) {
    const gameId = Object.keys(this.games).find(gameId =>
      this.games[gameId].hasPlayer(playerId)
    );
  ...
  playerSearchSingleGame(client) {
    ...
    return singleGame
      ? this.playerJoinSingleGame(client, singleGame)
      : this.playerCreateGame(client);
  }
  ...
  playerSearchGroupGame(client) {
    ...
    return groupGame
      ? client.onGamePending(groupGame.getState())
      : client.onGameEmpty();
  }
